...
class PerceiverVoxelLangEncoder(nn.Module):
    def __init__(
            ...
            layer=0,
            gs_dim = 64,              # dimentions of the gs context
    ...
    def forward(
        ...
        #TODO ings preprocessing
        #TODO pn2 set abstraction experiment
        #TODO fourrier pos embedding
        ####################
        ...
        for it in range(self.iterations):
            # encoder cross attention
            x = cross_attn(x, context=ings, mask=mask) + x # x: 1,2048,512, ins: 1,8077,128
